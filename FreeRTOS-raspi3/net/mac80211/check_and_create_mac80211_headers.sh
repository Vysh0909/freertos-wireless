#!/bin/bash
# -------------------------------------------------------------
# Script: check_and_create_mac80211_headers.sh
# Purpose:
#   Scan net/mac80211 source tree for headers
#   Ignore headers that already exist
#   Create missing ones under ../porting (outside net)
# -------------------------------------------------------------

# Base directories
PROJECT_ROOT="$(pwd)/../.."  # Assuming script is run from net/mac80211
SRC_DIR="net/mac80211"
